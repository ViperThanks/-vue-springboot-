...
import com.yiren.entity.Notic;
import com.yiren.service.NoticService;
...
public class NoticController {
    ...
    public ResponseResult getByNoticById(@NonNull Long id){
        try {
    ...
    @GetMapping("/delete")
    public ResponseResult delete(@NonNull Long id){
        try {
